...
class AudioPipe:
    """
    Pont audio WebSocket local entre Chrome headless et Gemini Live.
    Entrant  : PCM 16kHz int16 depuis les participants (Web Audio API)
    Sortant  : PCM 24kHz int16 depuis Gemini (voix de l'agent)
    """
